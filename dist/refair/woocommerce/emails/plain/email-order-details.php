...
echo wp_kses_post( wc_strtoupper( sprintf( esc_html__( '[Expression of interest #%1$s] (%2$s)', 'refair-theme' ), $order->get_order_number(), wc_format_datetime( $order->get_date_created() ) ) ) ) . "\n";
