...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			/* TVI ADD to handle hover and click ont mobile same element*/
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				$item_output .= '<a href="#" class="dropdown-toggle dropdown-toggle-split lg-display" id="menu-item-dropdown-' . $item->ID . '" role="button" data-toggle="dropdown"><span class="sr-only">Toggle Dropdown</span></a>';
