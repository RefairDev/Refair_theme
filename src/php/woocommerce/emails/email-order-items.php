...
$quantity_text_align        = $email_improvements_enabled ? 'right' : 'left';
...
foreach ( $items as $item_id => $item ) :
	...
	<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
		...
		<td class="td font-family text-align-<?php echo esc_attr( $quantity_text_align ); ?>" style="vertical-align:middle;">
			<?php
	...
	if ( $show_purchase_note && $purchase_note ) {
		?>
		<tr>
			<td colspan="2" class="font-family text-align-left" style="vertical-align:middle;">
				<?php
